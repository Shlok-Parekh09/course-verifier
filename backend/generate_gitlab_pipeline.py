...
for idx, chunk in enumerate(chunks):
    ...
    yaml_lines.extend([
        ...
        "    -   sudo apt-get update && sudo apt-get install -y curl xvfb x11-utils libgl1 tesseract-ocr libtesseract-dev",
        ...
        "    -   sudo chmod 600 /swapfile_extra && sudo mkswap /swapfile_extra || true && sudo swapon /swapfile_extra || true",
        "    - else",
