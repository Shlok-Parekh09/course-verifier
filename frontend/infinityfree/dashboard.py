...
try:
    ...
    if mongo_uri:
        ...
        print("No MONGO_URI found. Add your connection string to the .env file.")
                ...
                if tabs:
                    ...
                    for row in table:
                        if len(row) >= 4:
                            ...
                            # Robust header check to handle duplicated text (e.g., 'Attribute Attribute')
                            # caused by FPDF's bold text rendering (which draws text multiple times).
                            if 'attribute' in attr_name.lower(): continue
